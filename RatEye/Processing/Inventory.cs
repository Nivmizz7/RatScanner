...
namespace RatEye.Processing
{
    ...
    public class Inventory
    {
        ...
        {
            var (minHue, minSaturation, minValue) = _config.ProcessingConfig.InventoryConfig.MinHighlightingColor;
            var (maxHue, maxSaturation, maxValue) = _config.ProcessingConfig.InventoryConfig.MaxHighlightingColor;
        ...
        {
            var (minHue, minSaturation, minValue) = _config.ProcessingConfig.InventoryConfig.MinGridColor;
            var (maxHue, maxSaturation, maxValue) = _config.ProcessingConfig.InventoryConfig.MaxGridColor;
